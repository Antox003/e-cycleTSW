...
public class ProductModel {
	...
	public synchronized Collection<ProductBean> deleteProduct(int codiceProdotto, Collection<ProductBean> lista) throws SQLException {
	...
	public synchronized void updateProduct(ProductBean bean) throws SQLException {
	...
	public synchronized String getRandomCode() throws SQLException {
